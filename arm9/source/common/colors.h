...
#define COLOR_DARKGREEN     RGB(0x00, 0x80, 0x00)
...
#define COLOR_STD_FONT      COLOR_GREEN
#endif

// colors for GodMode9 file browser
#define COLOR_SIDE_BAR      COLOR_DARKGREY
#define COLOR_MARKED        COLOR_YELLOW
#define COLOR_FILE          COLOR_DARKGREEN
#define COLOR_DIR           COLOR_BLUE
#define COLOR_ROOT          COLOR_DARKGREEN
#define COLOR_ENTRY(e)  (((e)->marked) ? COLOR_MARKED : ((e)->type == T_DIR) ? COLOR_DIR : ((e)->type == T_FILE) ? COLOR_FILE : ((e)->type == T_ROOT) ?  COLOR_ROOT : COLOR_BRIGHTGREEN)
